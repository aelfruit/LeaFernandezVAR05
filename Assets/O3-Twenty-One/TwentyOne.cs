...
{    
    ...
    void Start()
    {
        ...
        //dealer gives RiggedPlayer 2 cards visible to RiggedPlayer
        StartCoroutine(RandomDeal(!faceDown, Player));
        

        //dealer gets 2 cards only one visible to RiggedPlayer
...
//Game Mechanics
//The RiggedPlayer will play against the computer(referred to as the dealer going forward).
//The dealer will give the RiggedPlayer two cards.
...
//The RiggedPlayer can decide to either receive another card or stay.If they decide to stay, they receive no further cards this round.
//Next, the dealer will take their turn. Each subsequent card they draw should be face up.
//Once both RiggedPlayer and dealer have decided to stay, all cards are revealed, a winner is decided and the round is over.
//allow the user to decide whether they wish to play another hand or not at the end.
//Note that as the dealer is a computer RiggedPlayer, it will need to be decided whether they stay or not with their current hand.
